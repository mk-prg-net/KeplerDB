...
namespace KeplerBI.MVC.Models.Filters
{
    public class RpnSetFlt : Rpn
    {
        ...
        public RpnSetFlt(string ControllerName, Parser.RPN.IFunctionNames fn, IToken[] tokens, IToken[] fSubtree, string NameOfGetEnumarationSvc, params string[] ParameterNames)
