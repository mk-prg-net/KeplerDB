...
namespace KeplerBI.MVC.Models.Filters
{
    public class Rpn
    {
        ...
        public Rpn(string ControllerName, Parser.RPN.IFunctionNames fn, IToken[] tokens, mko.RPN.IToken[] fSubtree, params string[] ParameterNames)
        {
            mko.TraceHlp.ThrowArgExIfNot(fSubtree.IsFunctionSubtree(), Properties.Resources.Models_Filters_ConfigData_rpn_function_functionname_token_missing);
        ...
        public Parser.RPN.IFunctionNames fn { get; }
