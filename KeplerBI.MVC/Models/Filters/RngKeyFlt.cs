...
namespace KeplerBI.MVC.Models.Filters
{
    public class RpnKeyFlt : Rpn
    {
        ...
        public RpnKeyFlt(string ControllerName, Parser.RPN.IFunctionNames fn, IToken[] tokens, IToken[] fSubtree, string NameOfAutocompleteSvc, params string[] ParameterNames)
