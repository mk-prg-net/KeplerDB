...
namespace DB.Kepler.EF60
{
    partial class Himmelskoerper : global::Kepler.IStern
    {
        ...
        double global::Kepler.IStern.Leuchtkraft_in_Lsonne
        {
            get
            {
                return Sterne_Planeten_MondeTab.Leuchtkraft_in_Lsonne;
            }
            set
            {
                Sterne_Planeten_MondeTab.Leuchtkraft_in_Lsonne = value;
            }
        }
    }
}
