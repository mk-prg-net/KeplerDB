...
namespace Kepler.OData.Controllers
{
    /*
    ...
    */
    public class PlanetsController : ODataController
    {
        ...
        public IHttpActionResult GetPlanets(ODataQueryOptions<Planet> queryOptions)
        {
            ...
            var planets = Orm.CelesticalBodies.OfType<NCB.Planet>().AsQueryable();

            return Ok<IEnumerable<Planet>>(Orm.CelesticalBodies.OfType<NCB.Planet>().AsQueryable());
